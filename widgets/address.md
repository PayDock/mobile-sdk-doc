...
---------------------|----------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|------------------------------------------------------------------------------------------------|
 ...
 `title`             | Defines the text appearance for section titles, such as the title for the address search section.                                            | `your.package.TextAppearance` (or equivalent)                   | `TextAppearanceDefaults.appearance()` with `titleMedium` style.                                |
 `textField`         | Defines the appearance for all manual address input text fields (e.g., street, city, postal code).                                           | `your.package.TextFieldAppearance` (or equivalent)               | `TextFieldAppearanceDefaults.appearance().copy(singleLine = true)`                             |
 `actionButton`      | Defines the appearance of the primary "Save Address" button.                                                                                 | `your.package.ButtonAppearance` (or equivalent)                  | `ButtonAppearanceDefaults.filledButtonAppearance()`                                            |
 `linkButton`        | Defines the appearance for interactive link-style buttons, such as "Enter Address Manually".                                                 | `your.package.LinkButtonAppearance` (or equivalent)              | `LinkButtonAppearanceDefaults.appearance()`                                                    |
 `searchDropdown`    | Defines the appearance of the address search input field and its associated dropdown results list.                                           | `your.package.SearchDropdownAppearance` (or equivalent)          | `SearchDropdownAppearanceDefaults.appearance()`                                                |
